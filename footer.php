    ...
    <div class="row">
      <div class="col-lg-4 d-none d-lg-block">
        <div class="row">
          <div class="col-lg-6 footer-post-col">
            <img src="<?php echo get_stylesheet_directory_uri( );?>/assets/images/resource-img.jpg" class="img-fluid mb-3" alt="Resources Post Image">
          ...
          <div class="col-lg-6 footer-post-col">
            <img src="<?php echo get_stylesheet_directory_uri( );?>/assets/images/careers-img.jpg" class="img-fluid mb-3" alt="Resources Post Image">
      ...
      <div class="col-lg-5 px-lg-3">
        <div class="text-center footer-logo">
          <img src="<?php echo get_stylesheet_directory_uri( );?>/assets/images/cm-logo-white.svg" class="img-fluid" alt="Footer White Logo">
        </div>
        <ul class="footer-menu list-unstyled mt-4">
          <li><a href="#">Allentown</a></li>
          <li><a href="#">Mechanicsburg</a></li>
          <li><a href="#">Bethlehem</a></li>
          <li><a href="#">Nursing & Rehab Center</a></li>
      ...
      <div class="col-lg-3 pt-4 pt-lg-0">
        <p class="pb-1 text-center text-lg-end">
          <a href="#" class="footer-white-button">Schedule a Personalized Visit</a>
        </p>
        <p class="mb-3 pb-3 text-center text-lg-end">
          <a href="#" class="footer-white-button">Speak to a Local Advisor</a>
        </p>
        <div class="footer-images-block pt-4 pt-lg-0 d-flex gap-5 gap-lg-2 gap-xl-4 flex-wrap justify-content-center justify-content-lg-end">
          <img src="<?php echo get_stylesheet_directory_uri( );?>/assets/images//equal-housing-opportunity.svg" class="img-fluid">
          <img src="<?php echo get_stylesheet_directory_uri( );?>/assets/images//great-place-to-work.svg" class="img-fluid">
          <img src="<?php echo get_stylesheet_directory_uri( );?>/assets/images//best-place-to-work.svg" class="img-fluid">
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-3 text-center text-lg-start pb-4 mb-2 pb-lg-0 mb-lg-0">
          <div class="wysiwyg-content text-white font-normal pb-1 pb-lg-0">
            <p>Our sister community, Ecumenical Retirement Community, offers affordable options in the Harrisburg area.</p>
          </div>
        </div>
        <div class="col-lg-6 text-center footer-bottom-mid-col">
          <ul class="footer-copyright-menu d-lg-flex flex-wrap column-gap-3 row-gap-1 list-unstyled mb-4 pb-2 mb-lg-3 pb-lg-0 justify-content-center">
            <li><a href="#">Home</a></li>
            <li><a href="#">Emergency Response Policy</a></li>
