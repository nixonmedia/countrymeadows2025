...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    /* -----------------------------------------
       EXCLUDE FOOTER FUNCTION (KEY FIX)
    ----------------------------------------- */

    function getResizableText() {
      return $(textSelector).filter(function () {
        return $(this).closest('footer').length === 0;
      });
    }

    function getResizableCaptions() {
      return $(captionSelector).filter(function () {
        return $(this).closest('footer').length === 0;
      });
    }
    ...
    function storeOriginalSizes() {
      ...
      getResizableText().each(function () {
        var $this = $(this);
      ...
      getResizableCaptions().each(function () {
        var $this = $(this);
        if (!$this.data("original-font-size")) {
          $this.data("original-font-size", $this.css("font-size"));
          $this.data("original-line-height", $this.css("line-height"));
    ...
    $(document).on('facetwp-loaded', function () {
      ...
      if ($("#large").hasClass("active")) {
        ...
        getResizableText().css({
          "font-size": "22px",
          "line-height": "32px"
        });

        getResizableCaptions().css({
          "font-size": "16px",
          "line-height": "24px"
        });
      }
    ...
    $("#large").on("click", function (e) {
      ...
      getResizableText().stop(true, true).animate({
        "font-size": "22px",
        "line-height": "32px"
      }, 200);

      getResizableCaptions().stop(true, true).animate({
        "font-size": "16px",
        "line-height": "24px"
      }, 200);
    });
