            ...
            <div class="review-slider ps-lg-4">
                <div class="bg-white p-4">
                   <div class="text-center d-flex justify-content-center pb-2">
                    ...
                    <div class="para-font pb-3">I can highly recommend Country Meadows Allentown to anyone seeking these types of services. My mother was only there for 4 months, but had to move through Independent Living...</div>
