...
<section class="py-5 resources-section">
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- RIGHT COLUMN -->
            <div class="col-lg-3 mt-5 mt-lg-5 resources-category-col">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="topic-card">
                            <div class="upper-content d-flex flex-column justify-content-center align-items-center">
                                ...
                                <img src="http://localhost/countrymeadows/wp-content/uploads/2025/11/Adoptation-Family-Streamline-Freehand-Duotone.png" class="">
